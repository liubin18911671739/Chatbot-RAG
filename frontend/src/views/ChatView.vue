...
export default {
  ...
  setup() {
    ...
    { text: '北京第二外国语学院住宿申请', type: 'local' },
    { text: '北京第二外国语学院校车时刻表', type: 'local' },
    { text: '北京第二外国语学院院系项目图书报销具体有哪些程序？', type: 'local' },
    { text: '北京第二外国语学院怎么找书？', type: 'local' },
    { text: '北京第二外国语学院房间有线网包月？', type: 'local' },
    { text: '北京第二外国语学院校外访问VPN？', type: 'local' },
    { text: '北京第二外国语学院院系项目图书报销具体有哪些程序？', type: 'local' },
    { text: '北京第二外国语学院图书馆有查重服务么？', type: 'local' },
    { text: '新生对个人职业发展感到迷茫怎么办？', type: 'local' },
    { text: '不了解面试流程、不懂面试技巧怎么办?', type: 'local' },
    { text: '不会写简历怎么办？', type: 'local' },
    { text: '简历修改', type: 'local' },
    { text: '院就业指导', type: 'local' },
    { text: '职业生涯规划', type: 'local' },
    { text: '模拟面试', type: 'local' },
    { text: '北京第二外国语学院面试技巧', type: 'local' },
    { text: '北京第二外国语学院面试全流程', type: 'local' },
    ...
    { text: '北京第二外国语学院第二课堂参加讲座在哪报名', type: 'local' },
    { text: '北京第二外国语学院第二课堂学分和综测分的相关性', type: 'local' },
    { text: '北京第二外国语学院讴客的分怎么算在综测里', type: 'local' },
    { text: '北京第二外国语学院请假流程', type: 'local' },
    { text: '北京第二外国语学院请假一天以上怎么申请', type: 'local' },
    { text: '北京第二外国语学院转专业要求', type: 'local' },
    { text: '北京第二外国语学院怎么转专业', type: 'local' },
    { text: '北京第二外国语学院离校', type: 'local' },
    { text: '北京第二外国语学院离校需要办什么手续', type: 'local' },
    { text: '北京第二外国语学院综测有什么用', type: 'local' },
    { text: '北京第二外国语学院综测用处', type: 'local' },
    { text: '北京第二外国语学院梧桐奖章报名', type: 'local' },
    { text: '北京第二外国语学院梧桐奖章评选要求', type: 'local' },
    { text: '北京第二外国语学院梧桐奖章奖励', type: 'local' },
    { text: '北京第二外国语学院校长奖章', type: 'local' },
    { text: '北京第二外国语学院校长奖章评选要求', type: 'local' },
    { text: '北京第二外国语学院勤工助学都有哪些岗位、包括哪些', type: 'local' },
    { text: '北京第二外国语学院勤工助学怎么申请', type: 'local' },
    { text: '北京第二外国语学院勤工助学补助条件', type: 'local' },
    { text: '北京第二外国语学院勤工助学补助什么时候申请，什么时候发', type: 'local' },
    { text: '北京第二外国语学院校园跑要求', type: 'local' },
    { text: '北京第二外国语学院校园跑距离和次数', type: 'local' },
    { text: '北京第二外国语学院心理咨询预约', type: 'local' },
    { text: '北京第二外国语学院心情不好在哪进行心理咨询', type: 'local' },
    { text: '北京第二外国语学院怎么控制购物的习惯', type: 'local' },
    { text: '北京第二外国语学院如何更好地与老师沟通', type: 'local' },
    { text: '北京第二外国语学院有没有学习小语种的方法', type: 'local' },
    { text: '北京第二外国语学院如何更好地利用数字二外', type: 'local' },
    { text: '北京第二外国语学院请你介绍一下北二外', type: 'local' },
    { text: '北京第二外国语学院我该如何向留学生介绍我的学校？', type: 'local' },
    { text: '北京第二外国语学院二外有哪些专业', type: 'local' },
    { text: '北京第二外国语学院梧桐奖章申请条件', type: 'local' },
    { text: '心理辅导', type: 'local' },
    { text: '985高校都包括哪些', type: 'local' },
    { text: '听音乐多久合适呢', type: 'local' },
    { text: '请介绍一下北二外人文楼', type: 'local' },
    { text: '北京第二外国语学院请你介绍一下小鸾', type: 'local' },
    { text: '北京第二外国语学院女生宿舍六号楼是啥', type: 'local' },
    { text: '北京第二外国语学院女生宿舍六号楼在哪', type: 'local' },
    { text: '北京第二外国语学院女生宿舍七号楼在哪呢', type: 'local' },
    { text: '北京第二外国语学院有哪些浴室', type: 'local' },
    { text: '北京第二外国语学院的快递点', type: 'local' },
    { text: '北京第二外国语学院求是楼', type: 'local' },
    { text: '北京第二外国语学院求是楼是干什么的', type: 'local' },
    { text: '北京第二外国语学院人文楼', type: 'local' },
    { text: '北京第二外国语学院人文楼是干什么的', type: 'local' },
